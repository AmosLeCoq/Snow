...
?>
    ...
    <td class="column-1"><button onclick="window.location.href='index.php?action=create'" class="flex-c-m size1 bg4 bo-rad-1 hov1 s-text1 trans-0-4">Ajouter</button></td><br>
